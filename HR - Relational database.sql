...
CREATE TABLE JOB_HISTORY (
    ...
    CONSTRAINT UK_JOB_HISTORY CHECK(END_DATE > START_DATE)
);

---CREATING INDEX FOR JOB HISTORY TABLE
CREATE INDEX IX_JOB_HISTORY_JOB_ID ON JOB_HISTORY(JOB_ID);
CREATE INDEX IX_JOB_HISTORY_EMPLOYEE_ID ON JOB_HISTORY(EMPLOYEE_ID);
CREATE INDEX IX_JOB_HISTORY_DEPARTMENT_ID ON JOB_HISTORY(DEPARTMENT_ID);

--CREATING INDEX FOR DEPARTMENTS TABLE
...
--CREATING INDEX FOR LOCATION TABLE
CREATE INDEX IX_LOCATIONS_COUNTRY_ID ON LOCATIONS(COUNTRY_ID);
CREATE INDEX IX_LOCATIONS_CITY ON LOCATIONS(CITY);
CREATE INDEX IX_LOCATIONS_STATE_PROVINCE ON LOCATIONS (STATE_PROVINCE);

--CREATING INDEX FOR COUNTRIES TABLE
...
CREATE INDEX IX_EMPLOYEES_NAME ON EMPLOYEES(FIRST_NAME, LAST_NAME);
...
Prompt ****** Inserting REGIONS table has been completed successfully....
...
Prompt ****** Inserting COUNTRIES table has been completed successfully....
...
Prompt ****** Inserting LOCATIONS table has been completed successfully....
...
-- BEFORE INSERTING DATA, DISABLING DEPARTMENTS CONSTRAINTS TO INSERT DATA SUCCESSFULLY
ALTER TABLE departments
  DISABLE CONSTRAINT FK_DEPARTMENTS_EMPLOYEES;
...
Prompt ****** Inserting DEPARTMENTS table has been completed successfully....
...
Prompt ****** Inserting JOBS table has been completed successfully....
...
Prompt ****** Inserting EMPLOYEES table has been completed successfully....
...
Prompt ****** Inserting JOB HISTORY table has been completed successfully....

COMMIT;

REM enable integrity constraint to DEPARTMENTS

-- AFTER INSERTING DATA, ENABLING DEPARTMENTS CONSTRAINTS
ALTER TABLE departments
  ENABLE CONSTRAINT FK_DEPARTMENTS_EMPLOYEES;
